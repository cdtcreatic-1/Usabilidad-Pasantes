...
from aplications.models import CheckList
from aplications.serializers import CheckListSerializer
    ...
    try:
        ...
        for heuristic, count in false_heuristics_count.items():
            ...
            if resultado:
                ...
                hfail = hi[int(numero_despues_de_h)] if int(numero_despues_de_h) < len(hi) else "Descripción no encontrada"
